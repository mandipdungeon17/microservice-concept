 ...
 *
 * <p>Currently emitted by the code: {@link #CREATED}, {@link #TRIGGERED}, {@link #COOLDOWN_SKIPPED},
 * {@link #DEACTIVATED}, {@link #EVALUATION_ERROR}. {@link #CONDITION_NOT_MET}, {@link #REACTIVATED},
 * and {@link #NOTIFICATION_FAILED} are reserved for future use (e.g. verbose tracing, reactivation
 * auditing, delivery-failure tracking) and are not written today.
 */
